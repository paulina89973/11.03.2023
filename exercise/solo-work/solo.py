...
for count, wykres in enumerate(wykresy):
    if wykres[0][1]/wykres[1][1] == wykres[2][1]/wykres[1][1]:
        print('Dla punktow w wykres_' + str(count+1) + " mozna wyznaczyc funkcje liniowa")
    else:
        print('Dla punktow w wykres_' + str(count+1) + " nie mozna wyznaczyc funkcji liniowej")
